...
const GoogleIcon = () => (
    <svg className="h-5 w-5" viewBox="0 0 48 48">
      ...
      <path fill="#34A853" d="M43.611 20.083H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C12.955 4 4 12.955 4 24s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" clipPath="url(#g)"></path>
      <path fill="#FBBC05" d="M24 4v8c5.176 0 9.387 4.211 9.387 9.388h8c0-9.596-7.804-17.388-17.387-17.388z" clipPath="url(#h)"></path>
      <path fill="#EA4335" d="M24 44c5.166 0 9.86-1.977 13.4-5.192l-5.657-5.657c-1.746 1.359-3.946 2.182-6.443 2.182-4.759 0-8.816-3.136-10.27-7.38H4.613v8.113C8.773 40.021 15.827 44 24 44z" clipPath="url(#i)"></path>
...
const LoginPage: React.FC = () => {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!success) { // Başarısızlık durumunda hata mesajı gösterilir, yönlendirme yapılmaz
